...
/*const corsOptions = {
  ...
  const corsOptions = {
    origin: ['http://localhost:3000', process.env.FRONTEND_URL, 'https://*.onrender.com/'], // Autoriser uniquement l'URL de votre frontend
  ...
  app.use((req, res, next) => {
    res.setHeader('Access-Control-Allow-Origin', 'https://*.onrender.com/'); // Autoriser l'origine de votre frontend
